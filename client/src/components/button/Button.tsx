...
export const Button = forwardRef<HTMLButtonElement, IButtonProps>(
  ({ className = "", variant = "secondary", children, ...props }, ref) => {
    const baseStyles =
      "hover:scale-102 cursor-pointer active:scale-98 transition-all flex items-center justify-center gap-2 px-4 py-1.5  disabled:opacity-50 disabled:pointer-events-none";
